...
const ComplaintList = () => {
    ...
    return (
            <div className="w-full h-screen pt-10 p-3 bg-slate-100">
                <div className='flex justify-center lg:w-full'>
                    <div className="flex mb-5 bg-gray-500 p-2 w-full justify-evenly rounded-full shadow-md overflow-hidden">
                        <button
